            ...
            <div className="flex flex-wrap md:flex-row gap-x-20 gap-y-9 justify-center ">
                <div className="flex flex-col gap-y-10 w-3xl">
                    <div className="flex flex-col gap-y-6 rounded-2xl border border-slate-200 shadow-xl shadow-gray-300 py-6 px-8 ">
                        ...
                        <span className="text-left leading-relaxed text-slate-600">
                            {course.description}
                        </span>
                    </div>
                <div className="flex flex-col gap-y-6 rounded-2xl border border-slate-200 shadow-xl shadow-gray-300 py-6 px-8 ">
                ...
                <div className="w-sm md:w-1/4 h-fit flex flex-col gap-y-7 p-5 rounded-2xl border-2 border-green-300  shadow-xl shadow-gray-300 mb-3">
                    ...
                    <div className=" flex flex-col gap-y-4">
                        ...
                        <div className="flex items-center justify-between">
                            ...
                            <span className="bg-blue-200/20 px-2 p-1.5 rounded font-semibold text-sm text-emerald-500 ">165</span>
                        </div>
                        <hr className="border-slate-300 w-full"/>
                        <div className="flex items-center justify-between">
                            <span className="font-semibold text-slate-700">Skill Level</span>
                            <span className="bg-blue-200/20 px-2 p-1.5 rounded font-semibold text-sm text-emerald-500 ">
                                {course.level}
                            </span>
                        </div>
                        <hr className="border-slate-300 w-full"/>
